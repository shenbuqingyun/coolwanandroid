package com.cool.wan.android.utils.fonts;
...
public class TypefaceHelper {
    ...
    public static void typeface(Activity activity) {
        ...
        typeface((View) activity.findViewById(android.R.id.content), sDefaultTypefaceCollection);
    }
    ...
    public static void typeface(Activity activity, TypefaceCollection typefaceCollection) {
        typeface((View) activity.findViewById(android.R.id.content), typefaceCollection);
    }
